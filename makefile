...
# Znacznik czasowy: 2020-11-02 23:37:34.551765
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -Wextra -Wno-error=implicit-fallthrough -D_GNU_SOURCE -D_ANSI_OUTPUT -Wno-error=unused-parameter -Wno-parentheses -Wall -ggdb3 -fdiagnostics-color -std=c11 -fmax-errors=5 -Werror=vla -Werror -xc -DINSIDE_DANTE -pedantic -Wno-error=parentheses 
...
${OUTDIR}/main: ${OUTDIR}/main.c.o ${OUTDIR}/unit_helper_v2.c.o ${OUTDIR}/unit_test_v2.c.o ${OUTDIR}/rdebug.c.o ${OUTDIR}/memmanager.c.o 
	@echo "Konsolidacja..."
	@${LD} ${LD_FLAGS} ${OUTDIR}/main.c.o ${OUTDIR}/unit_helper_v2.c.o ${OUTDIR}/unit_test_v2.c.o ${OUTDIR}/rdebug.c.o ${OUTDIR}/memmanager.c.o  -o ${OUTDIR}/main ${LD_LIBS}
